...
int __init hello_module_init(void){
	...
	printk("Semaphore lock linked list insert time : %d ns\n", insert_time);
	printk("Semaphore lock linked list search time : %d ns\n", search_time);
	printk("Semaphore lock linked list delete time : %d ns\n", delete_time);
	return 0;
}
